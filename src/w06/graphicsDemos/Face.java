...
public class Face extends JFrame {
    ...
    //DO NOT CALL - JAVA/SWING?AWT WILL CALL AS REQUIRED INCLUDING INITIALLY
    //ref. p1060 Savitch
    public void paint(Graphics g){      //g is really a Graphics2D object (modernised version of Graphics)
        super.paint(g);                 //downcast g to Graphics2D to use its extended functionality (because Graphics2D extends Graphics)
