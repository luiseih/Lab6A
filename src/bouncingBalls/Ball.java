 ...
 */
public class Ball {
    float x, y;           // bouncingBalls.Ball's center x and y (package access)
    float speedX, speedY; // bouncingBalls.Ball's speed per step in x and y (package access)
    float radius;         // bouncingBalls.Ball's radius (package access)
    private Color color;  // bouncingBalls.Ball's color
    ...
    /** Draw itself (centered on x, y) using the given graphics context. */
